clc;
clear;
%% Optimal Simple Rule for the BR model with backward looking Taylor rule
                                                                                                                                                        %
%% I: Parameterization
...
eta = 0.75;
std_mu = 0.15; std_kap = 0.15; std_nu = 0.15; % std. deviations of the shocks
        ...
        for d = 1:length(del_x)
            del_x_l = del_x(d); 
                ...
                parfor i = 1:nbrsim  
                    ...
                    [pi_t(i,:),x_t(i,:),i_t(i,:)] = nkmbr_function_backward_final(del_pi_l,del_x_l,T,[normrnd(0,std_mu,[1,T]);normrnd(0,std_kap,[1,T]);normrnd(0,std_nu,[1,T])],eta);
...
save('OSR_backwardTR_eta0.75_250sims.mat','optimal_par','Loss_average','M')