...
The function nkmbr_function_expect_final.m is the baseline model with a forward-looking TR:
...
The MATLAB file OSR_expect.m:
	derives the Optimal Simple Rule parameterization of the baseline model with forward-looking TR. 
	This is done by calculating the loss for all parameter combinations of delta_pi and delta_x.
	The parameters used in the seminar work are saved in OSR_expectTR_eta0.75_250sims.mat
